    ...
    (<div className={cn("relative", className)}>
      <div
        ...
        <div
          ...
          <div
            className="bg-zinc-900/10 flex items-center justify-center rounded-full backdrop-blur-md size-28 dark:bg-zinc-50/10">
            <div
        ...
        {isVideoOpen && (
          <motion.div
            ...
            <motion.div
              ...
              className="relative w-full max-w-[70%] aspect-video mx-4 md:mx-0">
              <motion.button
                className="absolute -top-16 right-0 text-white text-xl bg-neutral-900/50 ring-1 backdrop-blur-md rounded-full p-2 dark:bg-neutral-50 dark:text-black">
                <XIcon className="size-8" />
              </motion.button>
              <div
                className="size-full border-2 dark:border-zinc-800 rounded-2xl overflow-hidden isolate z-[1] relative">
                <iframe
                  src={videoSrc}
