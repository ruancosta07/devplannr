  ...
  if(type === "textarea"){
    return (
      <textarea
        id={id}
        className={twMerge(
          "w-full p-[1rem] rounded-[.6rem] border outline-none bg-zinc-100 border-zinc-300 hover:bg-zinc-200 focus:bg-zinc-200 mt-[.4rem] text-[1.4rem] duration-300 ease-in-out dark:bg-zinc-900 dark:border-zinc-800 hover:dark:bg-zinc-800/70 focus:dark:bg-zinc-800/70 resize-y min-h-[10rem] max-h-[16rem]  ",
          className
        )}
        // rows={1.5}
        onChange={(el:ChangeEvent<HTMLInputElement>) => {
